        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5 sm:p-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="flex flex-col gap-1.5 text-xs font-bold uppercase tracking-wider text-slate-400">Default workspace<select value={defaultView} onChange={(e) => setDefaultView(e.target.value)} className="rounded-xl border border-slate-800 bg-slate-950 px-3 py-2.5 text-sm font-normal normal-case tracking-normal text-white outline-none focus:border-amber-500/60"><option value="all_in_one">All-in-One AI</option><option value="markets">Markets</option><option value="news">News</option><option value="research">Research</option><option value="alerts">Alerts</option><option value="analytics">Analytics</option></select></label>
