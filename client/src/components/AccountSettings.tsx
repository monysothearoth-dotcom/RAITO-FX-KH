...
const APP_LOCAL_KEYS = ["raito_fx_alerts", "watchlist_symbols", "raito_custom_api_key", "raito_api_provider", "raito_av_key", "raito_cg_key", "raito_iex_key", "raito_simulated_ticks"];
        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-5 sm:p-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="flex flex-col gap-1.5 text-xs font-bold uppercase tracking-wider text-slate-400">Default workspace<select value={defaultView} onChange={(e) => setDefaultView(e.target.value)} className="rounded-xl border border-slate-800 bg-slate-950 px-3 py-2.5 text-sm font-normal normal-case tracking-normal text-white outline-none focus:border-amber-500/60"><option value="auto_signals">Auto Signal Analyze</option><option value="signals">Signal Analyze</option><option value="all_in_one">All-in-One AI Engine</option><option value="agent">AI Agent</option><option value="news">Economic Calendar &amp; News</option><option value="markets">Markets &amp; Chart</option><option value="pulse">Market Pulse</option><option value="research">Research Library</option><option value="alerts">Price Alerts</option><option value="journal">Trade Journal</option><option value="analytics">Portfolio Analytics</option></select></label>
