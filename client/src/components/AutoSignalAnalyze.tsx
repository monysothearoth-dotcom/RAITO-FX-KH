      ...
      <div className="relative overflow-hidden rounded-3xl border border-violet-500/35 bg-[radial-gradient(circle_at_90%_0%,rgba(139,92,246,0.17),transparent_42%),linear-gradient(135deg,rgba(15,23,42,0.98),rgba(17,24,39,0.94))] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.22)] sm:p-6">
        ...
        <div className="relative flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-400">The monitor combines transparent technical, setup, and macro-event scores. It suppresses setups below the configured confluence gate, saves every published signal, then tracks its TP or SL outcome from the same canonical record used for Telegram delivery.</p>
            <div className="mt-4 grid gap-2 sm:grid-cols-3"><div className="rounded-xl border border-violet-300/15 bg-slate-950/45 px-3 py-2"><span className="block text-[9px] font-mono uppercase tracking-wider text-slate-500">Coverage</span><span className="mt-0.5 block text-[10px] font-bold text-violet-100">Gold + Bitcoin focus</span></div><div className="rounded-xl border border-violet-300/15 bg-slate-950/45 px-3 py-2"><span className="block text-[9px] font-mono uppercase tracking-wider text-slate-500">Evidence</span><span className="mt-0.5 block text-[10px] font-bold text-violet-100">Confluence gate first</span></div><div className="rounded-xl border border-violet-300/15 bg-slate-950/45 px-3 py-2"><span className="block text-[9px] font-mono uppercase tracking-wider text-slate-500">Delivery</span><span className="mt-0.5 block text-[10px] font-bold text-violet-100">Dedicated Telegram route</span></div></div>
          </div>
          <div className="flex flex-col gap-2 rounded-2xl border border-slate-700/80 bg-slate-950/75 p-3 text-[11px] shadow-inner xl:min-w-72">
            <div className="flex items-center justify-between gap-4"><span className="font-mono uppercase text-slate-500">Monitor</span><span className={settings?.isEnabled ? "font-black text-emerald-300" : "font-black text-slate-400"}>{settings?.isEnabled ? "ACTIVE" : "STANDBY"}</span></div>
