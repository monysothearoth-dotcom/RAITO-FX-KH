      ...
      <div className="relative overflow-hidden rounded-3xl border border-violet-500/35 bg-[radial-gradient(circle_at_90%_0%,rgba(139,92,246,0.17),transparent_42%),linear-gradient(135deg,rgba(15,23,42,0.98),rgba(17,24,39,0.94))] p-5 shadow-[0_18px_50px_rgba(0,0,0,0.22)] sm:p-6">
        ...
        <div className="relative flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="max-w-2xl">
            <div className="flex flex-wrap items-center gap-2 text-[10px] font-black uppercase tracking-[0.16em] text-violet-200"><Radio className="h-3.5 w-3.5 animate-pulse" />Auto Signal Analyze <span className="rounded-full border border-violet-300/30 bg-violet-300/10 px-2 py-0.5 text-[9px]">XAU/USD ONLY</span></div>
